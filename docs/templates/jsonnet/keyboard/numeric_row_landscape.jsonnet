...
local keyboard(theme) =
  {
      ...
      // 左欄
      {
        VStack: {
          ...
          subviews: [
            // 第一行左：1 2 3 4 5
            { HStack: { subviews: [
              { Cell: 'number1RowButton' }, { Cell: 'number2RowButton' }, { Cell: 'number3RowButton' },
              { Cell: 'number4RowButton' }, { Cell: 'number5RowButton' },
            ] } },
            // 第二行左：- / : ; (
            { HStack: { subviews: [
              { Cell: 'hyphenRowButton' }, { Cell: 'slashRowButton' }, { Cell: 'colonRowButton' },
              { Cell: 'semicolonRowButton' }, { Cell: 'lparenRowButton' },
            ] } },
            // 第三行左：#+=, +, *, ., ,
            { HStack: { subviews: [
              { Cell: 'symbolicRowButton' }, { Cell: 'plusRowButton' }, { Cell: 'asteriskRowButton' },
              { Cell: 'chineseCommaRowButton' }, { Cell: 'chinesePeriodRowButton' },
            ] } },
            // 第四行左：返回, =, 空格
            { HStack: { subviews: [
              { Cell: 'returnRowButton' }, { Cell: 'equalRowButton' }, { Cell: 'spaceRowButton' },
            ] } },
          ],
        },
      },
      ...
      // 右欄
      {
        VStack: {
          ...
          subviews: [
            // 第一行右：6 7 8 9 0
            { HStack: { subviews: [
              { Cell: 'number6RowButton' }, { Cell: 'number7RowButton' }, { Cell: 'number8RowButton' },
              { Cell: 'number9RowButton' }, { Cell: 'number0RowButton' },
            ] } },
            // 第二行右：) $ & @ ※
            { HStack: { subviews: [
              { Cell: 'rparenRowButton' }, { Cell: 'dollarRowButton' }, { Cell: 'ampersandRowButton' },
              { Cell: 'lquoteRowButton' }, { Cell: 'rquoteRowButton' },
            ] } },
            // 第三行右：,, ?, !, ', backspace
            { HStack: { subviews: [
              { Cell: 'chinesePeriodRowButton' }, { Cell: 'ideographicCommaRowButton' }, { Cell: 'questionFullRowButton' },
              { Cell: 'exclamFullRowButton' }, { Cell: 'backspaceRowButton' },
            ] } },
            // 第四行右：空格, ", enter
            { HStack: { subviews: [
              { Cell: 'spaceRowButton' }, { Cell: 'dotRowButton' }, { Cell: 'enterRowButton' },
            ] } },
          ],
        },
      },
    ...
    // ===== 第一行：數字鍵 =====
    number1RowButton: createAlphaButton({ key: 'number1', action: { character: '1' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '１' } },
    ...
    number2RowButton: createAlphaButton({ key: 'number2', action: { character: '2' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '２' } },
    ...
    number3RowButton: createAlphaButton({ key: 'number3', action: { character: '3' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '３' } },
    ...
    number4RowButton: createAlphaButton({ key: 'number4', action: { character: '4' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '４' } },
    ...
    number5RowButton: createAlphaButton({ key: 'number5', action: { character: '5' }, size: { width: '146/784' }, bounds: { width: '146/200', alignment: 'left' } }) + { swipeUpAction: { character: '５' } },
    ...
    number6RowButton: createAlphaButton({ key: 'number6', action: { character: '6' }, size: { width: '200/784' }, bounds: { width: '146/200', alignment: 'right' } }) + { swipeUpAction: { character: '６' } },
    ...
    number7RowButton: createAlphaButton({ key: 'number7', action: { character: '7' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '７' } },
    ...
    number8RowButton: createAlphaButton({ key: 'number8', action: { character: '8' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '８' } },
    ...
    number9RowButton: createAlphaButton({ key: 'number9', action: { character: '9' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '９' } },
    ...
    number0RowButton: createAlphaButton({ key: 'number0', action: { character: '0' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '０' } },
    ...
    // ===== 第二行：符號鍵 =====
    hyphenRowButton: createAlphaButton({ key: 'hyphen', action: { character: '-' }, size: { width: '200/784' }, bounds: { width: '146/200', alignment: 'right' } }) + { swipeUpAction: { character: '－' } },
    ...
    slashRowButton: createAlphaButton({ key: 'slash', action: { character: '/' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '／' } },
    slashRowButtonForegroundStyle: utils.makeTextStyle({
      text: '/', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    colonRowButton: createAlphaButton({ key: 'colon', action: { character: ':' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '：' } },
    colonRowButtonForegroundStyle: utils.makeTextStyle({
      text: ':', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    semicolonRowButton: createAlphaButton({ key: 'semicolon', action: { symbol: ';' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '；' } },
    semicolonRowButtonForegroundStyle: utils.makeTextStyle({
      text: ';', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    lparenRowButton: createAlphaButton({ key: 'lparen', action: { character: '(' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '（' } },
    lparenRowButtonForegroundStyle: utils.makeTextStyle({
      text: '(', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    rparenRowButton: createAlphaButton({ key: 'rparen', action: { character: ')' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '）' } },
    rparenRowButtonForegroundStyle: utils.makeTextStyle({
      text: ')', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    dollarRowButton: createAlphaButton({ key: 'dollar', action: { character: '$' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '＄' } },
    dollarRowButtonForegroundStyle: utils.makeTextStyle({
      text: '$', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    ampersandRowButton: createAlphaButton({ key: 'ampersand', action: { character: '&' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '＆' } },
    ampersandRowButtonForegroundStyle: utils.makeTextStyle({
      text: '&', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    lquoteRowButton: createAlphaButton({ key: 'lquote', action: { character: '@' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '＠' } },
    lquoteRowButtonForegroundStyle: utils.makeTextStyle({
      text: '@', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    rquoteRowButton: createAlphaButton({ key: 'rquote', action: { character: '※' }, size: { width: '200/784' }, bounds: { width: '146/200', alignment: 'left' } }),
    ...
    plusRowButton: createAlphaButton({ key: 'plus', action: { character: '+' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '＋' } },
    plusRowButtonForegroundStyle: utils.makeTextStyle({
      text: '+', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    asteriskRowButton: createAlphaButton({ key: 'asterisk', action: { character: '*' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '＊' } },
    asteriskRowButtonForegroundStyle: utils.makeTextStyle({
      text: '*', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    chineseCommaRowButton: createAlphaButton({ key: 'chineseComma', action: { symbol: '.' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '。' } },
    chineseCommaRowButtonForegroundStyle: utils.makeTextStyle({
      text: '.', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    chinesePeriodRowButton: createAlphaButton({ key: 'chinesePeriod', action: { symbol: ',' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '，' } },
    chinesePeriodRowButtonForegroundStyle: utils.makeTextStyle({
      text: ',', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    ideographicCommaRowButton: createAlphaButton({ key: 'ideographicComma', action: { symbol: '?' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '？' } },
    ideographicCommaRowButtonForegroundStyle: utils.makeTextStyle({
      text: '?', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    questionFullRowButton: createAlphaButton({ key: 'questionFull', action: { character: '!' }, size: { width: '146/784' } }) + { swipeUpAction: { character: '！' } },
    questionFullRowButtonForegroundStyle: utils.makeTextStyle({
      text: '!', normalColor: color[theme]['Row数字键文字颜色'], highlightColor: color[theme]['Row数字键文字颜色'],
      fontSize: fontSize['Row数字键盘按键字体大小'],
    }),
    exclamFullRowButton: createAlphaButton({
      key: 'exclamFull',
      action: { symbol: '‘' },
      size: { width: '146/784' },
    }),
    ...
    // = 鍵（空格左方）
    equalRowButton: createAlphaButton({ key: 'equal', action: { character: '=' } }) + { size: { width: if settings.spaceKeyLayout == '1' then '173/784' else '146/784' } } + { swipeUpAction: { character: '＝' } },
    ...
    // “ 鍵（空格右方）
    dotRowButton: createAlphaButton({ key: 'dot', action: { character: '“' }, size: { width: if settings.spaceKeyLayout == '1' then '173/784' else '146/784' } }),
    ...
    enterRowButtonForegroundStyle: utils.makeTextStyle({
      ...
      fontSize: fontSize['Row数字键盘enter键字体大小'],
    }),
...

{
  new(theme, skinName='蝦米輸入法'):
    ...
    toolbar.getToolBar(theme, 'landscape', 'numeric', skinName) +
