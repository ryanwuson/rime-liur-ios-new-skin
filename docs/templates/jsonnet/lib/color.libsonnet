...

{
  light: {
    ...
    'kaomojis鍵盤左側collection背景下邊緣顏色': getCascadedSimpleProperty('kaomojis', 'leftPanel', 'shadow', 'light', 'shadow', '#9a9c9a'),
    'kaomojis鍵盤左側collection邊框顏色': getCascadedBorderColor('kaomojis', 'leftPanel', 'light', '#979faf80'),
    'kaomojis鍵盤左側collection邊框寬度': getCascadedBorderSize('kaomojis', 'leftPanel', 'light', 0),
    'kaomojis鍵盤右側collection背景顏色': getCascadedColor('kaomojis', 'rightPanel', 'panelRightBg', 'light', '#ffffff', 'normal'),
    'kaomojis鍵盤右側collection背景下邊緣顏色': getCascadedSimpleProperty('kaomojis', 'rightPanel', 'shadow', 'light', 'shadow', '#9a9c9a'),
    'kaomojis鍵盤右側collection邊框顏色': getCascadedBorderColor('kaomojis', 'rightPanel', 'light', '#ffffff'),
    'kaomojis鍵盤右側collection邊框寬度': getCascadedBorderSize('kaomojis', 'rightPanel', 'light', 0),
    'kaomojis鍵盤左側分類選中顏色': getCascadedSimpleProperty('kaomojis', 'leftPanel', 'categoryHighlight', 'light', 'keyNormalHighlight', '#ABB0BA'),
  ...
  dark: {
    ...
    'kaomojis鍵盤左側collection背景下邊緣顏色': getCascadedSimpleProperty('kaomojis', 'leftPanel', 'shadow', 'dark', 'shadow', '#1E1E1E'),
    'kaomojis鍵盤左側collection邊框顏色': getCascadedBorderColor('kaomojis', 'leftPanel', 'dark', '#D1D1D624'),
    'kaomojis鍵盤左側collection邊框寬度': getCascadedBorderSize('kaomojis', 'leftPanel', 'dark', 0),
    'kaomojis鍵盤右側collection背景顏色': getCascadedColor('kaomojis', 'rightPanel', 'panelRightBg', 'dark', '#D1D1D165', 'normal'),
    'kaomojis鍵盤右側collection背景下邊緣顏色': getCascadedSimpleProperty('kaomojis', 'rightPanel', 'shadow', 'dark', 'shadow', '#1E1E1E'),
    'kaomojis鍵盤右側collection邊框顏色': getCascadedBorderColor('kaomojis', 'rightPanel', 'dark', '#D1D1D165'),
    'kaomojis鍵盤右側collection邊框寬度': getCascadedBorderSize('kaomojis', 'rightPanel', 'dark', 0),
    'kaomojis鍵盤左側分類選中顏色': getCascadedSimpleProperty('kaomojis', 'leftPanel', 'categoryHighlight', 'dark', 'keyNormalHighlight', '#D1D1D624'),
