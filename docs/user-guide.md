...
按「匯入配置」選 `.cskin` 檔後，會跳出 **匯入配色主題** 視窗，先選要帶入哪些配色，再按「匯入」。

<img src="./screenshots/16-import-theme-modal.png" alt="匯入配色主題：選擇要帶入淺色、深色或全選" class="wide-img" />
...
> 版面、工具列、滑動、字體大小、皮膚名稱等設定**不論選哪個主題都會完整匯入**；只有「配色」與「AI 靈感」會依上表合併。
